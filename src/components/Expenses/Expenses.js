...
//Other option is to manage as useState(), not recommended as year excluded is based on 'filteredYear'. So, can be managed as derived state or computed state concept, means directly related to a state, so can be managed as a variable
